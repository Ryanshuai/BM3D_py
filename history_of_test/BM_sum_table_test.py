...
if __name__ == '__main__':
    ...
    sum_table_a = precompute_BM(im_flat, width, height, kHW=2, NHW=25, nHW=4, pHW=1, tauMatch=4000)
    sum_table_a = sum_table_a.reshape(-1, wh, wh)
    sum_table_b = my2_precompute_BM(im, width, height, kHW=2, NHW=3, nHW=4, pHW=1, tauMatch=4000)

    # print(aaa)
    # print(bbb)
    diff = sum_table_a - sum_table_b
    for aa, bb, di in zip(sum_table_a, sum_table_b, diff):
        print('-----------------')
        print(aa)
        print(bb)
        print(di)
